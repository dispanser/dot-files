...
n('<leader>es', builtin.lsp_document_symbols, "document symbols")
n('<leader>ew', builtin.lsp_workspace_symbols, "workspace symbols")
n('<leader>eW', builtin.lsp_dynamic_workspace_symbols, "dynamic workspace symbols")
