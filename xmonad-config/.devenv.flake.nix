{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/pi/src/github/dispanser/dot-files/xmonad-config";
  project_input_ref = "path:/home/pi/src/github/dispanser/dot-files/xmonad-config";
  devenv_dotfile = "/home/pi/src/github/dispanser/dot-files/xmonad-config/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-42a5ae9";
  ...
  hostname = "kite";
  username = "pi";
  git_root = "/home/pi/src/github/dispanser/dot-files";
  secretspec = null;
};
    in
    {
