...
local function date_exists(date_str)
    -- Check if a daily note file for the given date exists
    local filepath = vim.fn.expand("daily/" .. date_str .. ".md")
    return file_exists(filepath)
end

local function get_next_existing_date(current_date_str, direction)
    ...
    while iterations < max_iterations do
        ...
        if date_exists(new_date_str) then
            return new_date_str
        end
...
local function open_next_existing_file(direction)
    ...
    local next_date = get_next_existing_date(current_date, direction)
    if next_date then
        local filepath = vim.fn.expand("daily/" .. next_date .. ".md")
