...
nnoremap("<leader>rd", function() vim.cmd.RustLsp('debug') end, "debug")
nnoremap("<leader>rD", function() vim.cmd.RustLsp('debuggables') end, "show debuggables")
...
nnoremap("<leader>rr", function() vim.cmd.RustLsp('run') end, "run")
